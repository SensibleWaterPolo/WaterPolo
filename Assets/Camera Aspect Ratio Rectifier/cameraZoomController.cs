...
public class cameraZoomController : MonoBehaviour
{
    ...
    private Vector3 cameraPos; //gets default camera position

    private float defaultHeight; //needed to keep anchor top or bottom
    private float defaultAspectRatio; //needed to keep anchor in the sides
    private float defaultWidth = 5; //not needed, since could be obtained from other two
